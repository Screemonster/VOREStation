//
// TODO - Investigate what this is and why it exists
//	Okay, it seems this exists soley to:
//	A) Catch the emitter beams hitting the EM field
//	B) Make it not possible to walk thru the EM field.
//	TODO - Okay and they all get pre-created in advance to a radius
//		of seven no matter what size the EM field actually is...
//		and just decides to catch or not-catch based on actual size of EM field.
//		That is silly and we should do it differently.

// TODO - It also has some sort of "AddParticles" proc I don't understand.
//	Answer: Confirmed! Nothing ever calls AddParticles on this, it is useless!
