//
// RUST Fuel Injector Port
// This goes on a wall and is used to put fuel into the injector.
//
...
/obj/machinery/rust_fuel_assembly_port/update_icon()
	if(cur_assembly)
		icon_state = "port1"
	else
		icon_state = "port0"
