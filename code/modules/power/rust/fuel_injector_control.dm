//
// RUST Fuel Injector Control Console
//	This console lets you control the fuel injector or something.
//
...
/obj/machinery/computer/rust_fuel_control/interact(mob/user)
	if(stat & (BROKEN|NOPOWER))
		user.unset_machine()
		user << browse(null, "window=rust_fuel_control")
		return
	...
	user << browse(dat, "window=rust_fuel_control;size=800x400")
